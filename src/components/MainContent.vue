<template>
    <main>
      ...
      <div class="table-content">
        ...
        <TableSection :data="filteredData" :itemsPerPage="itemsPerPage"/>
      </div>
    </main>
</template>
...
export default {
  ...
  data() {
    return {
      data: [
        ...
        {id: 2, name: 'Cassie Cooper', date: '07/13/2024', time: '05:26 PM', status: 'OUT', logDetails: 'APP', location: 'Makati', company: 'McDollible', departmert: 'Product'},
        ...
        {id: 5, name: 'Elinor Terrell', date: '06/06/2024', time: '11:25 PM', status: 'OUT', logDetails: 'APP', location: 'Pasig', company: 'Mcdollible', departmert: 'Product'},
        ...
        {id: 8, name: 'Velasquez Conley', date: '03/30/2024', time: '03:38 AM', status: 'OUT', logDetails: 'APP', location: 'Pasay', company: 'Sprout Solutions', departmert: 'IT'},
  ...
  computed: {
    ...
    itemsPerPage() {
      if (this.filteredData.length === 0) {
        return `Showing 0 of ${this.filteredData.length}`
      } else {
        return `Showing 1 - ${this.filteredData.length} of ${this.filteredData.length}`
      }
    }
  },
  created() {
